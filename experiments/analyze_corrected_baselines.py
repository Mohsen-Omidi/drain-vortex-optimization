...
INFILE = "results/comparison_full_summary_corrected_baselines.csv"
OUT_RANKS = "results/comparison_full_ranks_corrected_baselines.csv"
OUT_OVERVIEW = "results/comparison_algorithm_overview_corrected_baselines.csv"
