...
INFILE = "results/comparison_full_summary_reference_settings.csv"
OUT_RANKS = "results/comparison_full_ranks_reference_settings.csv"
OUT_OVERVIEW = "results/comparison_algorithm_overview_reference_settings.csv"
