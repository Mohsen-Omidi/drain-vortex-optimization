...
BASE = "results/final_no_hho/comparison_full_summary_no_hho.csv"
HHO = "results/hho_fair_summary.csv"

OUT_SUMMARY = "results/comparison_full_summary_with_hho.csv"
OUT_RANKS = "results/comparison_full_ranks_with_hho.csv"
OUT_OVERVIEW = "results/comparison_algorithm_overview_with_hho.csv"

rows = []

for infile in [BASE, HHO]:
...
print("=== Algorithm overview with HHO ===")
for r in overview:
    print(
        f"{r['algorithm']:>6s} | "
